...
const FR_DICT = {
  ...
  contact: {
    ...
    form: {
      ...
      send: "Envoyer",
      sending: "Ouverture...",
      sent: "Merci ! Votre client mail va s'ouvrir avec le message pré-rempli.",
      bodyName: "Nom",
      bodyEmail: "Email",
...
const EN_DICT: DictShape = {
  ...
  contact: {
    ...
    form: {
      ...
      send: "Send",
      sending: "Opening...",
      sent: "Thanks! Your mail client will open with the message pre-filled.",
      bodyName: "Name",
      bodyEmail: "Email",
